<script lang="ts">
    ...
    function changeType(variable: VariableDefinition, type: ValueType) {
        updateVariable(variable.id, {
            type,
            defaultValue: coerceValueByType(
...
<section class="variables-panel">
    <div class="panel-header">
        ...
        <button class="icon-btn" onclick={addVariable} title="Add variable"
            >+</button
        >
    </div>
                ...
                <div class="variable-row">
                    ...
                    <select
                        ...
                        onchange={(event) =>
                            changeType(
                                variable,
                                event.currentTarget.value as ValueType,
                            )}
                    >
                    ...
                    <input
                        ...
                        onchange={(event) =>
                            changeDefault(variable, event.currentTarget.value)}
                    />

                    <div class="live-value" title="Current run value">
                        {valueToInput(
                            snapshot[variable.name] ?? variable.defaultValue,
                        )}
                    </div>
